...
<p align="center">
 <a target="_self" title="CLICK HERE to ENTER THE GATEWAY FREE!" href="https://mercwar.github.io/Navigator-MSVC-Academy/index.html"> 
   <img src="mw-msvc-acdmy.png" alt="Navigator MSVC Academy Banner" width="100%" style="border-radius: 4px; border: 1px solid #111;">
 </a>
</p>
...
- Professional open‑source README standards  
...
- MSVC compilation pipeline optimization  
...
# SECTION IV — DEVELOPMENT & CONTRIBUTION  
## 1. Coding Standards  
- C99 / ANSI C  
...
## 1. Delivery Channels  
### Online  
GitHub Pages version with sidebar and AJAX loader.

### Offline  
Clone repository and open `index.html` locally.
...
- Dynamic chapter loading via AJAX  
- AVIS‑aligned structural formatting  

## 3. Chapter Index  
- **C Foundations** — 01–10  
- **Win32 Subsystem** — 11–18  
- **MSVC Toolchain** — 19–22  
...
- Remove MercWar attribution from derivative works  
...
It is not a Microsoft technology.  
It is not part of the Windows operating system.  
It is not recognized as an official subsystem by Microsoft.
...
<p align="center">
  ...
  UNOFFICIAL MICROSOFT CURRICULUM  
  NATIVE WINDOWS ENGINEERING CONSTELLATION</strong>
</p>
